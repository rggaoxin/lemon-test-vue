    ...
    export default {
        ...
        methods: {
            ...
            saveEdit() {
                ...
                //     request_data.splice(-1, 1);   // 删除最后一个空元素
                // }else {
                //     paramsType = 'data';
                //     console.log('apiMsgData.variable: ', this.apiMsgData.variable);
                ...
                if (this.apiMsgData.choiceType === 'json'){
                    ...
                    if (request_data.length !== 0) {
                        datas.request.test.request['json'] = request_data
                    }
                }else if(this.apiMsgData.choiceType === 'params'){
                    paramsType = 'params';
                    request_data = this.apiMsgData.param;
                ...
                extract.splice(-1, 1);
                if (extract.length !== 0) {
                    let new_data = this.handleData2(extract, 'extract参数');
                    if (new_data.length === 0) {
                        return
                    }
                ...
                // console.log('Before-datas: ', datas);
